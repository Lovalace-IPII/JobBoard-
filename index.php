...
<body>
    <div class="container-xxl bg-white p-0">
        <!-- Spinner Start : A loading animation till the page starts-->
        ...
        <!-- Spinner End -->
        <?php include './componenets/mainNavbar.php'; ?>
        <!-- Carousel Start -->
                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                                    ...
                                    <p class="fs-5 fw-medium text-white mb-4 pb-2">Find Your Dream Job Today – Explore Thousands of Opportunities Across Top Companies!</p>
                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                                    ...
                                    <p class="fs-5 fw-medium text-white mb-4 pb-2">Hire Top Talent Fast – Connect with Skilled Professionals Ready to Drive Your Business Forward!</p>
        ...
        <!-- Testimonial End -->
        <?php include './componenets/mainFooter.php'; ?>
